    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
           <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto object-cover object-center px-24 rounded" src="https://m.media-amazon.com/images/I/5138s6Q1z-L._AC_UL320_.jpg" /> {/* https://m.media-amazon.com/images/W/IMAGERENDERING_521856-T1/images/I/713n+TxyfCL._AC_UL320_.jpg */}
